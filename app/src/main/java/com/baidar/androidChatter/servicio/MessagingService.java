...
package com.baidar.androidChatter.servicio;
...
import com.baidar.androidChatter.IniciarSesion;
import com.baidar.androidChatter.RealizarMensaje;
import com.baidar.androidChatter.R;
import com.baidar.androidChatter.comm.Socketer;
import com.baidar.androidChatter.interfaces.Actualizador;
import com.baidar.androidChatter.interfaces.Manejador;
import com.baidar.androidChatter.interfaces.SocketerInterface;
import com.baidar.androidChatter.toolBox.ControladorAmigo;
import com.baidar.androidChatter.toolBox.ControladorMensaje;
import com.baidar.androidChatter.toolBox.ManipuladorDeAlmacenamiento;
import com.baidar.androidChatter.toolBox.HandlerXML;
 ...
 */
public class MessagingService extends Service implements Manejador, Actualizador {
	...
	private ManipuladorDeAlmacenamiento localstoragehandler;
	
	private NotificationManager mNM;

	public class IMBinder extends Binder {
		public Manejador getService() {
    ...
    {   	
         ...
         localstoragehandler = new ManipuladorDeAlmacenamiento(this);
        // Display a notification about us starting.  We put an icon in the status bar.
     //   showNotification();
    	conManager = (ConnectivityManager) getSystemService(CONNECTIVITY_SERVICE);
    	new ManipuladorDeAlmacenamiento(this);
    ...
    private void showNotification(String username, String msg) {
        ...
        Intent i = new Intent(this, RealizarMensaje.class);
        i.putExtra(InformacionDeAmigo.USERNAME, username);
        i.putExtra(InformacionDeMensaje.MESSAGETEXT, msg);
	...
	public String authenticateUser(String usernameText, String passwordText) throws UnsupportedEncodingException {
		...
		if (result != null && !result.equals(IniciarSesion.AUTHENTICATION_FAILED))
		{			
			...
			i.putExtra(InformacionDeAmigo.FRIEND_LIST, rawFriendList);
			sendBroadcast(i);
			...
			{			
				public void run() 
				{
					try {					
						...
						if (tmp != null) {
							i.putExtra(InformacionDeAmigo.FRIEND_LIST, tmp);
							sendBroadcast(i);	
							Log.i("friend list broadcast sent ", "");
						
						if (tmp2 != null) {
							i2.putExtra(InformacionDeMensaje.MESSAGE_LIST, tmp2);
							sendBroadcast(i2);	
							Log.i("friend list broadcast sent ", "");
						}
						}
	...
	public void messageReceived(String username, String message) {
		...
		InformacionDeMensaje msg = ControladorMensaje.checkMessage(username);
		if ( msg != null){
			Intent i = new Intent(TAKE_MESSAGE);
		
			i.putExtra(InformacionDeMensaje.USERID, msg.userid);
			i.putExtra(InformacionDeMensaje.MESSAGETEXT, msg.messagetext);
			sendBroadcast(i);
			String activeFriend = ControladorAmigo.getActiveFriend();
	...
	public void updateData(InformacionDeMensaje[] messages,InformacionDeAmigo[] friends, InformacionDeAmigo[] unApprovedFriends, String userKey){
		...
		//FriendController.	
		ControladorMensaje.setMessagesInfo(messages);
		...
		ControladorAmigo.setFriendsInfo(friends);
		ControladorAmigo.setUnapprovedFriendsInfo(unApprovedFriends);
	}
}