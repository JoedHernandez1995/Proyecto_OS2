...
public class AgregarAmigos extends Activity implements OnClickListener {
    ...
    private final ServiceConnection mConnection = new ServiceConnection() {
        ...
        public void onServiceDisconnected(ComponentName className) {
            ...
            Toast.makeText(AgregarAmigos.this, R.string.local_service_stopped, Toast.LENGTH_SHORT).show();
        }
    };

    //  Remove deprecated method
    protected Dialog onCreateDialog(int id) {
        AlertDialog.Builder builder = new AlertDialog.Builder(AgregarAmigos.this);
    ...
    private void addNewFriend() {
        if (mFriendUserNameText.length() > 0) {
            ...
            Toast.makeText(AgregarAmigos.this, R.string.request_sent, Toast.LENGTH_SHORT).show();

            finish();
        } else {
            Log.e(LOG_TAG, "addNewFriend: username length (" + mFriendUserNameText.length() + ") is < 0");
            Toast.makeText(AgregarAmigos.this, R.string.type_friend_username, Toast.LENGTH_LONG).show();
        }
    }
}