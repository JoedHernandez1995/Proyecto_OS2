...
public class CrearUsuario extends Activity {
	...
	private ServiceConnection mConnection = new ServiceConnection() {
        ...
        public void onServiceDisconnected(ComponentName className) {
            ...
            // see this happen.
        	imService = null;
            Toast.makeText(CrearUsuario.this, R.string.local_service_stopped,
	...
	protected Dialog onCreateDialog(int id) {
		...
		switch (id) 
		{
			case TYPE_SAME_PASSWORD_IN_PASSWORD_FIELDS:			
				return new AlertDialog.Builder(CrearUsuario.this)
	...
	protected void onResume() {
		bindService(new Intent(CrearUsuario.this, MessagingService.class), mConnection , Context.BIND_AUTO_CREATE);
