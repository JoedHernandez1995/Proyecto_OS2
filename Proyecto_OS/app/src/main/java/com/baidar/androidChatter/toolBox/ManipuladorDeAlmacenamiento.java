...
public class ManipuladorDeAlmacenamiento extends SQLiteOpenHelper {

	private static final String TAG = ManipuladorDeAlmacenamiento.class.getSimpleName();
	...
	public ManipuladorDeAlmacenamiento(Context context) {
